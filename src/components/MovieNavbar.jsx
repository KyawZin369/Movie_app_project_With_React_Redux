      ...
      <Flowbite>
        <Navbar fluid>
          ...
          <Navbar.Collapse className="flex items-center justify-between">
            <div className="flex md:order-2 my-7 md:my-0 md:mx-9">
              <Button color="blue" className="my-2">Log In / Log Out</Button>
              <DarkThemeToggle className="bg-gray-300 dark:bg-gray-100 my-2 mx-9 text-blue-600 dark:text-blue-400" />
            </div>
            <label
